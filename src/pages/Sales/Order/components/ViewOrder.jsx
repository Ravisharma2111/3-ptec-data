...
const ViewOrder = () => {
  ...
  useEffect(() => {
    const fetchDataFromApi = async () => {
      try {
        ...
        console.log("Error fetching OrderList:", payload);
    ...
    fetchDataFromApi();
  }, [viewOrderStatus, itemsPerPage, searchText, items,selectedCustomer]);
  ...
  const filteredStocks = orderData?.data?.filter((stock) => {
    const matchesCustomer = !selectedCustomer || stock?.orgid == selectedCustomer;
    const matchesSearch = stock?.customername.toLowerCase().includes(searchText.toLowerCase());
            ...
            <TableBody>
              {filteredStocks?.map((data, index) => (
                ...
                >
                  ...
                  <StyledTableBodyCell>  <Button onClick={() => handleOrderNumberId(data?._id?.$oid)}>
                    {data.orderno}
              ...
              <TableBody>
                ...
                >
                  ...
                  <StyledTableHeaderCell>
                    {
                      invoiceData?.itemtaxfields["59d35c47e4b0c1f361b0d955"].taxcode
                    }
                  </StyledTableHeaderCell>
